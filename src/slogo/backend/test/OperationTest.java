...
public class OperationTest {
    ...
    public void testOperationFactory () {
        String[] commands = { "Sum", "Forward", "And" };
    ...
    public void testRepeat () {
        ISyntaxNode child = new SyntaxNode("Constant", new Constant("50"),
                new ArrayList<ISyntaxNode>());
        ...
        ISyntaxNode constant = new SyntaxNode("Constant", new Constant("3"),
                new ArrayList<ISyntaxNode>());
        List<ISyntaxNode> repeatList = new ArrayList<ISyntaxNode>();
        repeatList.add(constant);
        repeatList.add(forward);
