...
public class BackendTest {
    ...
    public void testRepeat () throws Exception {
        ...
        assertEquals(6.0, result.turtles().get(Constants.DEFAULT_TURTLE_NAME).turtlePosition()
                .getX());
    }
    ...
    public void testFor () throws Exception {
        ...
        assertEquals(8.0, result.turtles().get(Constants.DEFAULT_TURTLE_NAME).turtlePosition()
                .getX());
    }
