...
public class Or extends MathOperation{
    private static final String COMMAND_NAME = "Or";
	...
	protected Number executeMath(List<Number> args) {
		return (args.get(0).intValue() != Constants.FALSE_INT) || (args.get(1).intValue() != Constants.FALSE_INT) ? 
		        Constants.TRUE_INT : Constants.FALSE_INT;
	}
