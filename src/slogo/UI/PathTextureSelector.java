...
public class PathTextureSelector {
    ...
    protected void create (Group root, Turtle t) {
        ...
        sc.setUpSelector("Path Texture", AppConstants.SELECTOR_WIDTH, AppConstants.SELECTOR_HEIGHT,
                         AppConstants.SELECTOR_FONT_SIZE, possibleTextures);
        ...
        VBox selectorWithLabel =
                sc.createSelectorWithLabel("Select a Path Texture", AppConstants.LABEL_FONT_SIZE,
                                           Color.BLACK);
