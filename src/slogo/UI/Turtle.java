...
public class Turtle {
        ...
        for (String file : fileList.keySet()) {
            Image I =
                    new Image(getClass().getResourceAsStream(file),
                              AppConstants.MAX_NEW_IMAGE_WIDTH, AppConstants.MAX_NEW_IMAGE_HEIGHT,
                              true, true);
    ...
    protected void setImage (String name, Group root) {
        ...
        moveTurtle(xpos + AppConstants.MAX_NEW_IMAGE_WIDTH / 2, ypos +
                   AppConstants.MAX_NEW_IMAGE_HEIGHT /
                   2);
